...
class ValidateSensorLogRecord extends FilterFunc {


  def exec(input : Tuple)  = {
    ValidateSensorLogRecord.dateStringToMillis(input.get(0).asInstanceOf[String])
  }
}
object ValidateSensorLogRecord
{
